...
let mockMixes: Mix[] = [
	{
		...
		likes: 100,
		release: release1,
		src: `${environment.baseUrl}Release 1 - Mix 1.m4a`,
		duration: null,
	...
	},
	{
		...
		likes: 99,
		release: release1,
		src: `${environment.baseUrl}Release 1 - Mix 2.m4a`,
		duration: null,
		isCurrentlyPlaying: false,
		isPlayingMix: false,
	},
	{
		...
		likes: 98,
		release: release1,
		src: `${environment.baseUrl}Release 1 - Mix 3.m4a`,
		duration: null,
		isCurrentlyPlaying: false,
		isPlayingMix: false,
	},
	{
		...
		likes: 90,
		release: release2,
		src: `${environment.baseUrl}Release 2 - Mix 1.m4a`,
		duration: null,
		isCurrentlyPlaying: false,
		isPlayingMix: false,
	},
	{
		...
		likes: 95,
		release: release2,
		src: `${environment.baseUrl}Release 2 - Mix 2.m4a`,
		duration: null,
		isCurrentlyPlaying: false,
		isPlayingMix: false,
	},
	{
		...
		likes: 200,
		release: release3,
		src: `${environment.baseUrl}Release 3 - Mix 1.m4a`,
		duration: null,
		isCurrentlyPlaying: false,
		isPlayingMix: false,
	},
